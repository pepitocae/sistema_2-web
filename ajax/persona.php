...
$clabe=isset($_POST["clabe"])? limpiarCadena($_POST["clabe"]):"";
$contacto=isset($_POST["contacto"])? limpiarCadena($_POST["contacto"]):"";

switch ($_GET["op"]){
	case 'guardaryeditar':
		if (empty($idpersona)){
			$rspta=$persona->insertar($tipo_persona,$nombre,$rfc,$direccion,$telefono,$email,$giro,$banco,$cuenta,$clabe,$contacto);
			echo $rspta ? "Persona registrada" : "Persona no se pudo registrar";
		}
		else {
			$rspta=$persona->editar($idpersona,$tipo_persona,$nombre,$rfc,$direccion,$telefono,$email,$giro,$banco,$cuenta,$clabe,$contacto);
